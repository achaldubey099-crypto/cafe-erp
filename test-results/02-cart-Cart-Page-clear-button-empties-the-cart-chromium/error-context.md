...
- Name: 02-cart.spec.ts >> Cart Page >> clear button empties the cart
- Location: tests/02-cart.spec.ts:39:7
...
Locator: locator('text=Test Latte')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Test Latte')
